...
<body>
    ...
    <form action="./index.php" method="POST" id="form">
        ...
        <label>
            ФИО:<br>
            <input name="field-name-1" placeholder="Костенко Никита Алексеевич" type="name" <?php if ($errors['field-name-1']) {
                print 'class="error"';
        ...
        <label>
            Email:<br>
            <input name="field-email" placeholder="nik.kostenko.04@bk.ru" type="email" <?php if ($errors['field-email']) {
                print 'class="error"';
        ...
        <label>
            ...
            <textarea name="field-bio" <?php if ($errors['field-bio']) {
                print 'class="error"';
            } ?>><?php print $values['field-bio']; ?></textarea>
        </label><br>
